...
export class DisposalRealEstateView {
    ...
    constructor(
        ...
        this.nationalConsumerPriceIndexDisposal = nationalConsumerPriceIndexDisposal;
        this.nationalConsumerPriceIndexAcquisition = nationalConsumerPriceIndexAcquisition;
