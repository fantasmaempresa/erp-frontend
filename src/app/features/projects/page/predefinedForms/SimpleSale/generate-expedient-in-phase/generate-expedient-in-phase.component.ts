...
@Component({
  selector: 'app-generate-expedient-in-phase',
  templateUrl: './generate-expedient-in-phase.component.html',
  styleUrls: ['./generate-expedient-in-phase.component.scss']
})
export class GenerateExpedientInPhaseComponent implements PredefinedFormLifeCycle, OnInit, OnDestroy {
  @ViewChild(HostDirective, { static: true }) container!: HostDirective;
  componentRef!: ComponentRef<any>;
  public viewActionBuilder: ViewActionsBuilder<DocumentDto>;
  ...
  constructor(
    ...
    this.form = new FormGroup({
      phase: new FormControl('Expediente', []),
    });
  ...
  private getLocalInjector() {
    return Injector.create({
      providers: [{ provide: VIEW_CLAZZ, useValue: DocumentLinkPhaseView }],
      parent: this.inj,
    });
  }
